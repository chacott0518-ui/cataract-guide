...
export const HOME_INTRO: HomeIntro = {
  ...
  paragraphs: [
    "노안백내장은 가까운 거리의 초점 조절력이 떨어지는 노안과 수정체가 혼탁해지는 백내장이 함께 나타나는 상태를 말합니다. 노안·백내장은 서로 다른 변화이지만 비슷한 연령대에서 함께 나타날 수 있어, 증상만으로 판단하기보다 검사 결과와 평소 생활 방식을 함께 확인하는 과정이 필요합니다.",
    "같은 시야 불편이라도 원인과 판단 기준이 다를 수 있습니다. 검사에서 수정체 상태와 일상 영향이 확인되면, 필요에 따라 백내장 수술과 인공 수정체 선택을 검토하는 흐름으로 이어질 수 있습니다.",
...
export const HOME_SECTIONS: ArticleSection[] = [
  {
    ...
    paragraphs: [
      "중장년층에서는 노안/백내장이 함께 거론되는 경우가 많지만, 같은 불편함처럼 보여도 검사 결과에 따라 관리 방향이 달라질 수 있습니다. 이 사이트는 일반적인 정보 안내이며 개인의 진단이나 치료를 대신하지 않습니다.",
      ...
      "증상이 비슷해도 직업, 사용하는 거리(근거리·운전·야간 활동)에 따라 우선 확인할 내용이 달라질 수 있습니다. 검사로 어떻게 구분하는지는 수술 전 검사 안내에서 이어서 확인할 수 있습니다.",
    ],
    comparison: {
      left: {
        label: "노안",
    ...
    relatedLabel: "노안백내장 수술 전 검사로 구분 확인하기",
  },
  {
    id: "home-symptoms",
    order: 2,
  ...
  },
  {
    ...
    layout: "steps",
    directAnswer:
      "노안백내장 수술은 시야 불편 정도, 일상생활 영향, 필요한 시야 범위, 검사상 눈 상태를 종합해 검토합니다. 증상이 있다고 모든 사람에게 같은 시점에 수술이 필요하다고 보기 어렵습니다.",
    paragraphs: [
      "수술 시기는 단순 연령만으로 정해지지 않습니다. 검사 결과와 시야 불편, 일상·업무·운전에 실제로 얼마나 지장이 있는지, 의료진 판단을 함께 보는 경우가 많습니다.",
      ...
      "양안 수술을 한 번에 할지, 한쪽씩 나눌지도 검사 결과·생활 일정·회복 계획에 따라 달라질 수 있습니다. 진행 방식의 개요는 수술 과정 안내에서 확인할 수 있습니다.",
    ],
    steps: [
      {
        label: "01 증상 확인",
  ...
  },
  {
    ...
    order: 4,
    numberLabel: "04",
    heading: "노안백내장 수술의 단초점렌즈와 다초점렌즈 비교",
    layout: "compare-table",
    directAnswer:
      "단초점 인공수정체는 특정 거리 중심으로 초점을 맞추고, 다초점 렌즈는 여러 거리 활용을 목표로 설계됩니다. 연속초점렌즈(초점심도확장 계열)도 시야 목표가 다를 수 있어, 어느 한쪽이 무조건 우수하다고 단정할 수는 없습니다.",
    paragraphs: [
      "선택 기준으로는 망막 상태, 동공 크기, 야간 운전 빈도, 근거리 작업량, 안경 보조 수용도를 함께 보는 편이 안전합니다.",
      ...
      "유형별 차이와 상담 질문은 단초점·다초점 비교 안내에서, 제품·허가 정보 확인은 인공수정체 안내에서 이어서 볼 수 있습니다. 연속초점 렌즈를 검토하는 경우에도 시야 목표와 한계를 같은 기준으로 비교하는 것이 좋습니다.",
    ],
    ...
    relatedLabel: "단초점·다초점·연속초점 비교 자세히 보기",
  },
  {
    id: "home-cost",
    order: 5,
    ...
    layout: "info-blocks",
    directAnswer:
      "노안백내장 수술비용은 렌즈 종류, 검사 구성, 난시 교정 여부, 사후관리 포함 범위에 따라 달라질 수 있습니다. 전국 공통 가격처럼 단정할 수 있는 금액은 없습니다.",
    paragraphs: [
    ...
    infoBlocks: [
      ...
      {
        label: "노안백내장 인공수정체 종류",
        text: "단초점·다초점·연속초점·난시 교정 등 선택에 따라 구성이 달라집니다.",
      },
      {
        label: "노안백내장 수술 범위",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "다초점 렌즈를 선택한 경우 시야 적응에 수주에서 수개월이 걸릴 수 있으며, 일부 거리에서는 안경 보조가 필요할 수 있다는 설명을 함께 듣는 것이 기대 관리에 도움이 됩니다.",
