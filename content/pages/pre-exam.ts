  ...
  sections: [
    {
      ...
      order: 1,
      numberLabel: "01",
      heading: "검사에서는 노안과 백내장을 어떻게 구분하나요?",
      layout: "prose",
      decorativeIcon: "📌",
      directAnswer:
        "증상만으로 원인을 단정하기보다, 시력·수정체·안구 구조 검사로 가까운 초점 조절 저하와 수정체 혼탁이 각각 어느 정도인지 확인하는 과정입니다.",
      paragraphs: [
        "가까운 글씨가 흐리거나 초점이 잘 안 맞을 때 노안을, 시야가 뿌옇거나 야간 빛 번짐이 커질 때 백내장을 의심하는 경우가 있습니다. 다만 비슷한 불편이어도 검사 결과에 따라 우선 확인할 원인이 달라질 수 있습니다.",
        "이 페이지는 검사·상담에서 어떻게 구분해 설명받는지에 초점을 둡니다. 노안백내장의 기본 정의와 차이의 큰 흐름은 메인 안내에서 먼저 확인할 수 있습니다.",
      ],
      relatedHref: ROUTES.home,
      relatedLabel: "노안백내장 전체 안내에서 차이 요약 보기",
    },
    {
      id: "pre-exam-why",
      order: 2,
    ...
    },
    {
      ...
      paragraphs: [
        "시야가 흐려도 당장 수술이 필요하지 않은 경우도 있고, 일상 활동에 지장이 커지면 시점을 다시 논의하는 경우도 있습니다. 기다리거나 진행하는 선택은 검사 결과, 시야 불편, 일상생활 영향, 의료진 판단에 따라 달라질 수 있습니다.",
